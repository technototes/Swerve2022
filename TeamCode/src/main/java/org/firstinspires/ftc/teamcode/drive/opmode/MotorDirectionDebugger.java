...
public class MotorDirectionDebugger extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ElapsedTime looptimeChecker = new ElapsedTime();
        while (!isStopRequested()) {
            ...
            if(gamepad1.x) {
                ...
                drive.setModuleVelocities(SERVO_POWER, 0, 0, 0);
                telemetry.addLine("Running Motor: Front Left");
            } else if(gamepad1.y) {
                drive.setMotorPowers(0, 0, 0, MOTOR_POWER);
                drive.setModuleVelocities(0, 0, 0, SERVO_POWER);

                telemetry.addLine("Running Motor: Front Right");
            } else if(gamepad1.b) {
                drive.setMotorPowers(0, 0, MOTOR_POWER, 0);
                drive.setModuleVelocities(0, 0, SERVO_POWER, 0);

                telemetry.addLine("Running Motor: Rear Right");
            } else if(gamepad1.a) {
                drive.setMotorPowers(0, MOTOR_POWER, 0, 0);
                drive.setModuleVelocities(0, SERVO_POWER, 0, 0);
